...
#ifndef __P2PUSERAPITRACE_H_
#define __P2PUSERAPITRACE_H_

// CONSTANTS
_LIT( KP2PUserApiPanic, "P2P User Panic:" );
...
#ifdef __WINS__
#define ASSERT_PANIC_ALWAYS(a,b) if(!(a)){User::Panic( KP2PUserApiPanic, b);};
